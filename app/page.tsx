...
export default function Home() {
    ...
    return (
        <div className="max-w-full min-h-screen flex flex-col bg-primary-blue-dark">
            <div
                className="mx-auto sm:my-24 my-4 text-secondary-gray-medium bg-secondary-gray-light min-w-1/2 p-4 rounded-lg flex flex-col justify-center items-center">
                ...
                {totalCumulativeDoseMg && !isMostLikelyValueError && (
                    <div
                        className="bg-secondary-green-dark w-full mt-12 rounded-lg py-8 px-2 text-secondary-gray-light flex flex-col justify-center items-center gap-4">
                        <p>
                            Total Iron deficit :{" "}
                        ...
                        <div className='bg-secondary-green w-full mt-12 rounded-lg flex flex-col justify-start items-center gap-4 '>
                            <p>
                                For children over 1 month old: Dilute 100mg mg 1:1 with NS Infuse over 30 min
                            </p>


                            <p>
                                For children over 1 month old: Dilute 200mg in 200 mL NS. Infuse over 1 hour
                            </p>


                            <p>
                                For children over 1 month old: Dilute 300 in 250ml. NS. Infuse at least 90 minutes
                            </p>
                        </div>
                    </div>
                )}
